...
class AppNoteController extends ResourceController {
  ...
  Future<Response> getNote(
    ...
    try {
      ...
      String message = "Успешное получение фионансового отчета";
      ...
      return AppResponse.serverError(e, message: 'Ошибка получения финансового отчета');
    }
  }
  ...
  Future<Response> updateNote(
    ...
    try {
      ...
      return AppResponse.ok(
          body: note.backing.contents, message: "Успешное обновление финансового отчета");
    } catch (e) {
      return AppResponse.serverError(e, message: 'Ошибка получения финансового отчета');
    }
  }
  ...
  Future<Response> deleteNote(
    ...
    try {
      ...
      return AppResponse.serverError(e, message: 'Ошибка удаления финансового отчета');
    }
  }
  ...
  Future<Response> createNote(
    ...
    try {
      ...
      return AppResponse.serverError(e, message: 'Ошибка создания финансового отчета');
    }
  }
}
